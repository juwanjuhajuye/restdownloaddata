...
//        alterDatabaseTableColumn(altTableName, "stationnumber_type", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 stationnumber_size 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "stationnumber_size", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 ordernumber_type 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "ordernumber_type", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 ordernumber_position 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "ordernumber_position", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 customerinfo_yn 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "customerinfo_yn", "nvarchar(2)", "DEFAULT 'Y'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 totalamount_size 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "totalamount_size", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 tip_type 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "tip_type", "nvarchar(2)", "DEFAULT '1'");
//
////        // salon_storestationsettings_system_receipt 테이블 컬럼 추가
////        // 1.20.2023 tip_size 추가
//        altTableName = "salon_storestationsettings_system_receipt";
//        alterDatabaseTableColumn(altTableName, "tip_size", "nvarchar(2)", "DEFAULT '1'");
//        //
