...
import com.example.jjbfather.jjjqsrt2go2gorestdownload.API_tableqrcodeset_tocloud;
        ...
        if (returnApiValue.equals("00")) {
            ...
            Thread thread = new Thread() {
                ...
                public void run() {
                    ...
                    // 테이블명 구하기
                    String tablename = MainActivity.mDbInit.dbExecuteReadReturnString( " select tablename from salon_store_restaurant_table where idx = '" + tableIdx + "' " );
